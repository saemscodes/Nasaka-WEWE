...
public class NasakaWeweRecyclerView extends FrameLayout {
	...
	public NasakaWeweRecyclerView(Context context) {
		this(context, null, 0);
	}

	public NasakaWeweRecyclerView(Context context, @Nullable AttributeSet attrs) {
	...
	public NasakaWeweRecyclerView(Context context, @Nullable AttributeSet attrs,
		...
		TypedArray attributes = context.obtainStyledAttributes(attrs,
				R.styleable.NasakaWeweRecyclerView);
		isScrollingToEnd = attributes
				.getBoolean(R.styleable.NasakaWeweRecyclerView_scrollToEnd, true);
		int drawableRes = attributes
				.getResourceId(R.styleable.NasakaWeweRecyclerView_emptyImage, -1);
		if (drawableRes != -1) setEmptyImage(drawableRes);
		String emtpyText =
				attributes.getString(R.styleable.NasakaWeweRecyclerView_emptyText);
		if (emtpyText != null) setEmptyText(emtpyText);
		String emtpyAction =
				attributes.getString(R.styleable.NasakaWeweRecyclerView_emptyAction);
	...
	private void initViews() {
		View v = LayoutInflater.from(getContext()).inflate(
				R.layout.nasaka_wewe_recycler_view, this, true);
